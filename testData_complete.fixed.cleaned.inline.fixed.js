window.testData = {
        ...
        "questions": [
          ...
          },
          {
            ...
            "options": [
              "is permanently connected to the battery",
              "supplies galley power",
              "carries all me non-essential loads",
              "is connected to the battery in an emergency"
            ],
            "answer": "is permanently connected to the battery",
            "correct": 0,
      ...
      },
      {
        ...
        "questions": [
          ...
          },
          {
            ...
            "test": 2,
            "id": 541,
            "question": "Which of the following correctly describes the gyroscope of a rate of turn indicator? i. 1 degree of freedom ii. 2 degrees of freedom iii. Its frame is held by two springs iv. Its spin axis is parallel to the pitch axis v. The spin axis is parallel to the yaw axis vi. The spin axis is horizontal",
            "options": [
              "it is down",
              "the amber light is on",
              "mechanically locked by an \"over-centre\" mechanism",
    ...
    "tests": [
      {
        ...
        "questions": [
          ...
          },
          {
            ...
            "answer": "230 from the headland, using the headland's meridian",
            "correct": 2,
            "explanation": ""
          },
          {
    ...
    "tests": [
      {
        ...
        "questions": [
          ...
          },
          {
            ...
            "answer": "require a decrease in the mass",
        ...
        "questions": [
          {
            ...
            "answer": "C",
            "explanation": "ADF (Automatic Direction Finder) is susceptible to specific errors. Option C lists three valid ones: 1) **Angle of bank** (Dip error in the loop antenna), 2) **Mountain effect** (reflection/diffraction of waves by terrain), and 3) **Station interference** (due to NDBs sharing frequencies or skywave interference). Options A and B contain errors not specific to ADF (Tropospheric propagation is VHF; Slant range is DME)."
          },
          {
            "category": "radio-navigation-test-1",
            "test": 1,
            ...
            "answer": "B",
            "explanation": "The Doppler shift depends on **relative motion**. If the transmitter and receiver are moving **apart** (opening velocity), the wavelength stretches, causing the frequency to **decrease**. If they were moving together, the frequency would increase."
          },
          {
            "category": "radio-navigation-test-1",
            "test": 1,
            ...
            "answer": "C",
            "explanation": "This is an inherent design characteristic of the Glideslope antenna. It radiates a pattern with **multiple lobes**. The lowest lobe (approx 3°) is the valid path. Higher lobes (e.g., 6°, 9°) create 'false' glide paths with reversed sensing (fly up/fly down indications are flipped)."
          }
        ]
      }
    ]
  ...
  "instrumentation": {
    ...
    "tests": [
      {
        "id": "instrumentation-test-1-extra",
        "name": "Extra",
        "timeLimit": 60,
        "questions": [
          {
            "category": "instrumentation-test-1-extra",
            "test": 1,
            "id": 1518,
            "question": "Refer to Appendix A. Which diagram shows the MAP display?",
            "options": [
            ...
            "answer": "C",
            "explanation": "Requires the visual reference 'Appendix A'. In a standard EFIS (Electronic Flight Instrument System), the MAP display is the mode showing a plan view of the route, waypoints, and active leg, usually in a 'Track Up' orientation."
          },
          {
            "category": "instrumentation-test-1-extra",
            "test": 1,
            ...
            "answer": "C",
            "explanation": "Airborne Weather Radar (AWR) is overlaid on navigation displays that provide a 'Plan' or 'Map' view. These include **Plan (i), Map (iii), Full VOR (vii), Expanded VOR (viii), and Centre Map (ix)**. Modes focused on ILS approach deviations (ii, v) typically do not support radar overlay."
          },
          {
            "category": "instrumentation-test-1-extra",
            "test": 1,
            ...
            "answer": "A",
            "explanation": "If the static vents are blocked on the ground, the air pressure trapped inside the altimeter casing is equal to the airfield pressure (QNH). As the aircraft climbs, this trapped pressure cannot escape or change. Therefore, the altimeter stays frozen at the altitude corresponding to that pressure: the **airfield elevation**."
          }
        ]
      }
    ]
  ...
  "meteorology": {
    ...
    "tests": [
      {
        "id": "meteorology-test-1-extra",
        "name": "Extra",
        "timeLimit": 60,
        "questions": [
          {
            "category": "meteorology-test-1-extra",
            "test": 1,
            "id": 1520,
            ...
            "answer": "B",
            "explanation": "IRVR (Instrumented Runway Visual Range) reporting is triggered when visibility conditions deteriorate. The standard ICAO/EASA requirement is to report RVR when the meteorological visibility is **less than 1500m**."
          }
        ]
      }
    ]
  ...
  "performance": {
    ...
    "tests": [
      {
        "id": "performance-test-1-extra",
        "name": "Extra",
        "timeLimit": 60,
        "questions": [
          {
            "category": "performance-test-1-extra",
            "test": 1,
            "id": 1521,
            "question": "Which conditions are most suited to a selection of lower flap for take-off?",
            "options": [
            ...
            "answer": "A",
            "explanation": "Lower flaps = Less Drag (better climb) but Less Lift (longer ground roll). You choose this when you have a **long runway** (to handle the roll) but need to maximize climb performance due to performance-limiting factors like **high airfield elevation** and **high temperature**."
          },
          {
            "category": "performance-test-1-extra",
            "test": 1,
            ...
            "answer": "B",
            "explanation": "This is a tricky exam standard. Thicker slush creates massive drag. To take off safely, the aircraft mass (TOM) must be significantly reduced. Because the aircraft is now much lighter, its acceleration and stopping capabilities are better than a heavy aircraft. Therefore, the *adjustment* (reduction) to V1 required for the slush is **smaller** than it would be for a heavier aircraft in thinner slush."
          }
        ]
      }
    ]
  ...
  "general-navigation": {
    ...
    "tests": [
      {
        "id": "general-navigation-test-1-extra",
        "name": "Extra",
        "timeLimit": 60,
        "questions": [
          {
            "category": "general-navigation-test-1-extra",
            "test": 1,
            "id": 1523,
            "question": "You are heading 080°(T) when you get a range and bearing fix from your AWR (Airborne Weather Radar) on a headland at 185 NM 30° left of the nose. What true bearing do you plot on the chart?",
            "options": [
            ...
            "answer": "D",
            "explanation": "1. **Bearing TO Headland:** Heading 080° - 30° (Left) = 050°. 2. **Bearing FROM Headland (to plot):** Reciprocal of 050° = 230°. 3. **Reference:** When plotting on a chart, you align your plotter with the meridian of the known station (the Headland). Result: **230° from the headland, using the headland's meridian**."
          },
          {
            "category": "general-navigation-test-1-extra",
            "test": 1,
            ...
            "answer": "B",
            "explanation": "Using departure formulas: Latitude difference is only 2'. Longitude difference is 33'. Departure (NM) = 33 * cos(48°) ≈ 22 NM. Since the North/South change is negligible compared to the East/West change, the distance is **22 NM** and the track is nearly East (approx 086°)."
          }
        ]
      }
    ]
  ...
  "flight-planning": {
    ...
    "tests": [
      {
        "id": "flight-planning-test-1-extra",
        "name": "Extra",
        "timeLimit": 60,
        "questions": [
          {
            "category": "flight-planning-test-1-extra",
            "test": 1,
            "id": 1526,
            ...
            "answer": "B",
            "explanation": "In the context of Upper Routes (UR) on EASA charts, the vertical limits usually start at FL245. The first usable cruising level above this is **FL250**. (Note: Some specific iterations of this exam question refer to a chart note enforcing FL280, but without the chart, FL250 is the standard 'base' level for the airway)."
          }
        ]
      }
    ]
